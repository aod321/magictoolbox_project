    ...
    body: {
      ...
      data: [
        ...
        },
        {
          path: "/magic-toolkit",
          component: "Layout",
          redirect: "/magic-toolkit/experiment",
          name: "/magicToolkit",
          meta: {
            title: "魔法工具箱",
            icon: "magic-wand",
          ...
          children: [
            {
              path: "experiment",
              component: "magic-toolkit/experiment/index",
              name: "Experiment",
              meta: {
                title: "实验记录管理",
                icon: "experiment",
